...
PARAM_SCHEMA: dict[str, dict[str, Any]] = {
    ...
    "weight_full": {"component": "number", "label": "full weight", "value": 20, "info": "随机策略下 full 权重。"},
    "weight_face": {"component": "number", "label": "face weight", "value": 50, "info": "随机策略下脸部权重。"},
    "weight_body": {"component": "number", "label": "body weight", "value": 50, "info": "随机策略下身体权重。"},
    "weight_halfbody": {"component": "number", "label": "halfbody weight", "value": 45, "info": "随机策略下上半身权重。"},
